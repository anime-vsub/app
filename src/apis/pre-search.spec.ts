...
describe("pre-search", () => {
  test("normal", async () => {
    import.meta.env.DATA = `<li><a style="background-image: url('http://cdn.animevietsub.cc/data/poster/2022/02/24/animevsub-vziyRxKpU1.jpg')" class="thumb" href="http://animevietsub.cc/phim/tonikaku-kawaii-2nd-season-a4476/"></a>
    <div class="ss-info">
