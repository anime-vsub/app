<template>
  ...
  <q-page>
    ...
    <SkeletonGridCard v-if="!data" :count="12" />
...
const { data, error, run } = useRequest(() => fetchTypeNormalValue(1, false))
const title = ref("")
